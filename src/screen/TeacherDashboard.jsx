...
const TeacherDashboard = () => {
  ...
  // fucntion that handle evaluation depends on the user role
  const openEvaluation = () => {
    if (role === "Teacher") {
      navigate("/evaluation-form/2");
    } else {
      navigate("/evaluation-form/5");
    }
  };
                ...
                {piechartLoading ? (
                  ...
                  <>
                    ...
                    chartData?.length === undefined ? (
                      ...
                      <h1 className="uppercase text-black">{role} OVERALL RATING RESULT : {pieChartData?.average_overall_rating_score}</h1>
                    )}
                  </>
                )}
              </h1>

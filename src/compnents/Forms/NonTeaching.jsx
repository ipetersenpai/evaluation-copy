...
import { getUserNonTeachingList } from "../../redux/slices/userSlice/getListOfUsersNonTeachingSlice";
...
const NonTeaching = () => {
  ...
  const userList = useSelector((state) => state.userNonTeaching.data);
  ...
  useEffect(() => {
    ...
    dispatch(getUserNonTeachingList());
  }, [dispatch]);
